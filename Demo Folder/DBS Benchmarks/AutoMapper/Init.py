...
spark.sql("CREATE SCHEMA IF NOT EXISTS yash_gupta_hackerspace.automap_demo")

# COMMAND ----------

# Create the gold schema
spark.sql("""
CREATE TABLE IF NOT EXISTS yash_gupta_hackerspace.automap_demo.gold_financials (
    Ticker STRING,
