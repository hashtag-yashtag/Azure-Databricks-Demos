...
def get_automl_credit_decision_run(force_refresh = False): 
  ...
  from_cache, r = get_automl_run_or_start(credit_automl_run_name, credit_model_name, fs.read_table(f'yash_gupta_fsi_credit.yash_gupta_fsi_credit.creditdecisioning_features'), "defaulted", 5, move_to_production=False)
  return r
