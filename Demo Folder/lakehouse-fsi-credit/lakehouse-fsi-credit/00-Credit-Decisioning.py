...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F00-Credit-Decisioning&demo_name=lakehouse-fsi-credit&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-credit%2F00-Credit-Decisioning&version=1">
...
# MAGIC
# MAGIC Directly open the final <a href="/sql/dashboards/2933f1c1-bff5-48f6-9111-0318a97fb453" target="_blank">dashboard</a> depicting the business outcomes of building the credit decisioning on the Databricks Lakehouse, including:
